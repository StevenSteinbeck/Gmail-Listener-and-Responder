...
EMAIL_ACCOUNT = "stevens@allsmile.net"
EMAIL_PASS = '0045Apds0045sdpa'
...
def send_email(lname, fname, email):
    ...
    # Authentication 
    s.login(fromaddr, '0045Apds0045sdpa') 
...
#setup by filter in gmail. When gabby sends email with Audit Request in Subject, will sort and pull data for email. Get Guarantor name and pass through to program with single ledger output as goal.
...
Started
['Dana White', 'stevens@aplusdental.us']
['Kim Vo', 'gabrielles@aplusdental.us']
['hugh janus', 'stevens@aplusdental.us']
